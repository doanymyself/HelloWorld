...
public class CommonDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewGroup common_dialog_title_layout = (ViewGroup) this
                .findViewById(R.id.common_dialog_title_layout);
        ...
        if (title != null) {
            ...
            common_dialog_title_layout.setVisibility(View.GONE);
        }
        // content不为空
